...
spec =
  describe "QuickSort" $ do
    ...
    it "Map" $ property $ prop_IsSorted ssort id id
    it "Map Par" $ property $ prop_IsSorted (pSort 4) id id
    ...
    it "Array" $ property $ prop_IsSorted (A.quicksort @P) (A.fromList Seq) A.toList
    it "Array Par" $ property $ prop_IsSorted (A.quicksort @P) (A.fromList (ParN 4)) A.toList
